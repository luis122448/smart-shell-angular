...
@Component({
  selector: 'app-register-detail-inventory-taking',
  templateUrl: './register-detail-inventory-taking.component.html',
  styleUrls: ['./register-detail-inventory-taking.component.scss']
})
export class RegisterDetailInventoryTakingComponent implements OnChanges{
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    if(changes['isCalculateDocument'] && changes['isCalculateDocument'].currentValue === true){
      if(this.detailDocument.controls.length <= 1){
        ...
        this.documentInventoryTakingService.setStatusInventoryTakingRegisterDetail(false);
        return;
      }
      ...
      this.documentInventoryTakingService.setStatusInventoryTakingRegisterDetail(true);
    }
  }
